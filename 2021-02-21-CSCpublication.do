...
//	PNS2019
	ta I00101
	gen planPNS2019=I00101
		recode planPNS2019 1=1 2=0
...
//	PNS2013
	ta J036
	encode J036, generate (notseekPNS2013)
...
/**********************************
4e. Difficulty of access (4f + 4g + 4h)
**********************************/
...
//	PNAD2008
	...
	ta agePNAD2008 // indivíduos com 18 anos ou mais usar ">18"
...
//	PNS2013
	...
	ta agePNS2013 // indivíduos com 18 anos ou mais usar ">18"
		
// 	PNS2019
	ta C008 if banco==2
	generate agePNS2019=C008 if banco==2
		destring agePNS2019, replace
	ta agePNS2019 // indivíduos com 18 anos ou mais usar ">18"
